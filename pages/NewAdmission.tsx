...
const NewAdmission: React.FC<NewAdmissionProps> = ({ isDemo }) => {
    ...
    const [formData, setFormData] = useState<Partial<Child>>({
        ...
        arrival_date: new Date().toISOString().split('T')[0], transferred_from: '', transferred_date: '', responsible_organ: '',
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (isLocalAdmin) {
                if (!viewingInstId) throw new Error("Selecione uma instituição na Gestão de Casas para realizar esta ação.");
            ...
            const { data: newChild, error: insertError } = await supabase
                .from('children')
                .insert([{ ...payload, institution_id: institutionId }])
                .select()
                .single();
                    ...
                    <div className="p-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div>
                                ...
                                <input type="date" name="date_of_birth" value={formData.date_of_birth} onChange={handleChange} className="w-full border-gray-300 rounded-md border p-2 text-gray-900 focus:ring-[#458C57] focus:border-[#458C57]" required />
                            </div>
                            <div>
                ...
                <section className="bg-white shadow-sm rounded-lg border border-gray-200 overflow-hidden">
                    ...
                    <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="date" name="arrival_date" value={formData.arrival_date} onChange={handleChange} className="w-full border-gray-300 rounded-md border p-2 text-gray-900" required />
                        </div>
                        <div>
